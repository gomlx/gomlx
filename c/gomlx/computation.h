...
// computation.h holds C API wrapper for xla::Builder, xla::Computation, xla::Literal,
// xla::GlobalData and related functionality.
...
struct Computation {
    ...
    // XlaComputation, available only after the Computation has been built. Computation owns the memory,
    // so if Computation is deleted, this has to be freed as well.
