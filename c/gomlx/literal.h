...
// literal.h holds C API structure to literal values: this header and implementation are included
 // in the thiner gomlx_aot library.
...
typedef struct Literal {
    ...
    // Tuple objects are a collection of several literals, and don't have data themselves.
    bool is_tuple;

    // Shape information.
    Shape *shape;

    // Consecutive data: array of some value defined by dtype (xla::PrimitiveType).
    void *data;
