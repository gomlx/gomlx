...
// SerializedNode represents the Node arguments needed to create an XlaOp. The underlying
// data (pointers) are owned by Go, and shouldn't be freed by C functions.
typedef struct {
    ...
    // Information about the new op created, filled in by ComputationAddOp. Space allocated in C, but
    // ownership is transferred back to Go.
    XlaOp *new_op;
    Shape *new_shape;
