...
import (
	...
	. "github.com/gomlx/gomlx/support/pjson" // Import the library being tested
)
...
func TestPolymorphicSameJSONTypeResolution(t *testing.T) {
	...
	expectedJSON := `{
  "optimizer_config": {
    "type": "*github.com/gomlx/gomlx/support/pjson_test.MyOptimizer",
    "value": {
      "learning_rate": 0.005
    }
  },
  "scheduler_config": {
    "type": "*github.com/gomlx/gomlx/support/pjson_test.MyScheduler",
    "value": {
      "warmup_steps": 500
    }
  }
