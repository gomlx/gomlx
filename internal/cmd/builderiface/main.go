...
func main() {
	...
	w("// normalizedBuilderFn is the normalized function used internally by the exec.Exec object.\n")
	...
	w("\tdefault:\n")
	w("\t\treturn nil, 0, 0, errors.Errorf(\"model object passed (%%T) doesn't implement any of the valid Build methods signatures supported, see documentation in exec.NewExec for details\", builderAny)\n")
	w("\t}\n}\n")
