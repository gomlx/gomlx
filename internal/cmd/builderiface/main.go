...
func main() {
	...
	w("// Package builderiface defines BuilderIf a constraining interface for the builder closures accepted by models.NewExec.\n")
	w("package builderiface\n\n")
	w("// This package is generated by internal/cmd/builderiface. DO NOT EDIT.\n\n")
	w("import (\n")
