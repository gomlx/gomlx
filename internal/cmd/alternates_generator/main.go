...
func processFileForTag(tag string, baseName, sourceFileName string, lines []string) {
	...
	// Write header.
	fmt.Fprint(writer, "// *** DO NOT EDIT ***: File generatored by internal/cmd/alternates_generator.\n")
