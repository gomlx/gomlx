...
// Generated by `cmd/graph_constraints_generator`:
...
//
// Exec takes care of creating parameters (with graph.Parameter) for every value passed to Exec.Call before
...
// "side parameters".
//
// The values to feed these "side parameters" are not passed to Exec.MustCall, but instead set with a SideParamsFn, which
// is configured here.
//
...
func (e *Exec) CallWithGraphOnDevice(defaultDevice compute.DeviceNum, args ...any) (
...
// ExecWithGraphOnDevice is a deprecated alias to CallWithGraphOnDevice.
//
// Deprecated: use CallWithGraphOnDevice instead.
