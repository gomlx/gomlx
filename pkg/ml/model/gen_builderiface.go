...
func convertToNormalizedBuilderImpl(builderAny any) (builderFn normalizedBuilderFn, numInputs, numOutputs int, err error) {
	...
	default:
		return nil, 0, 0, errors.Errorf("model object passed (%T) doesn't implement any of the valid Build methods signatures supported, see documentation in exec.NewExec for details", builderAny)
	}
}
