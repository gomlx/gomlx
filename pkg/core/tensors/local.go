...
// Even scalar values have a flattened data representation of one element.
//
// Notice that for packed sub-byte packed values (Int1, Uint1, Int2, Uint2, Int4, Uint4), this gives access to the raw bytes,
...
//
// Sub-byte packed values (Int1, Uint1, Int2, Uint2, Int4, Uint4) are unpacked to int8 before being returned,
...
func (t *Tensor) ValueSafe() (any, error) {
	var mdSlice any
	err := t.ConstFlatData(func(flat any) {
		// Packed sub-byte types (Int1, Uint1, Int2, Uint2, Int4, Uint4) are stored as []uint8
