...
const _NodeTypeName = ""

var _NodeTypeIndex = [...]uint16{0, 7, 16, 19, 22, 31, 40, 61, 81, 98, 106, 113, 123, 133, 142, 152, 166, 170, 175, 178, 185, 196, 200, 208, 219, 231, 234, 237, 240, 250, 262, 280, 285, 300, 303, 306, 311, 314, 319, 325, 339, 363, 374, 395, 403, 407, 411, 419, 424, 435, 456, 464, 482, 485, 490, 500, 510, 519, 529, 537, 540, 543, 546, 549, 557, 575, 578, 587, 590, 605, 609, 625, 640, 656, 672, 687, 703, 712, 721, 734, 743, 755, 758, 765, 772, 777, 782, 792, 802, 812, 831, 850, 859, 879, 896, 900, 903, 908, 912, 916, 919, 923, 932, 937, 942}

const _NodeTypeLowerName = ""
...
func _NodeTypeNoOp() {
	...
	_ = x[NodeTypeSqrt-(98)]
	_ = x[NodeTypeSub-(99)]
	_ = x[NodeTypeTanh-(100)]
	_ = x[NodeTypeTranspose-(101)]
	_ = x[NodeTypeWhere-(102)]
	_ = x[NodeTypeWhile-(103)]
}
...
var _NodeTypeNameToValueMap = map[string]NodeType{
	...
	_NodeTypeName[908:912]:      NodeTypeSort,
	_NodeTypeLowerName[908:912]: NodeTypeSort,
	_NodeTypeName[912:916]:      NodeTypeSqrt,
	_NodeTypeLowerName[912:916]: NodeTypeSqrt,
	_NodeTypeName[916:919]:      NodeTypeSub,
	_NodeTypeLowerName[916:919]: NodeTypeSub,
	_NodeTypeName[919:923]:      NodeTypeTanh,
	_NodeTypeLowerName[919:923]: NodeTypeTanh,
	_NodeTypeName[923:932]:      NodeTypeTranspose,
	_NodeTypeLowerName[923:932]: NodeTypeTranspose,
	_NodeTypeName[932:937]:      NodeTypeWhere,
	_NodeTypeLowerName[932:937]: NodeTypeWhere,
	_NodeTypeName[937:942]:      NodeTypeWhile,
	_NodeTypeLowerName[937:942]: NodeTypeWhile,
}
...
var _NodeTypeNames = []string{
	...
	_NodeTypeName[919:923],
	_NodeTypeName[923:932],
	_NodeTypeName[932:937],
