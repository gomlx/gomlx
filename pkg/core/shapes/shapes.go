...
//
// Panics if any dimension is dynamic (DynamicDim). Use HasDynamicDims to check first.
//
...
// Shapes with nil AxisNames are considered equal to shapes with all-empty AxisNames.
