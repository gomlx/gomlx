...
var (
	...
	initializationCoefficients = map[initCacheKey]*initCacheValue{
		...
		initCacheKey{Approximation: "leaky_relu_0.1", Version: "B", NumeratorDegree: 5, DenominatorDegree: 4}: &initCacheValue{
		...
		initCacheKey{Approximation: "leaky_relu_0.1", Version: "A", NumeratorDegree: 3, DenominatorDegree: 2}: &initCacheValue{
		...
		initCacheKey{Approximation: "leaky_relu_0.1", Version: "B", NumeratorDegree: 3, DenominatorDegree: 2}: &initCacheValue{
		...
		initCacheKey{Approximation: "leaky_relu_0.1", Version: "C", NumeratorDegree: 3, DenominatorDegree: 2}: &initCacheValue{
		...
		initCacheKey{Approximation: "leaky_relu_0.1", Version: "A", NumeratorDegree: 5, DenominatorDegree: 4}: &initCacheValue{
		...
		initCacheKey{Approximation: "leaky_relu_0.1", Version: "C", NumeratorDegree: 5, DenominatorDegree: 4}: &initCacheValue{
		...
		initCacheKey{Approximation: "swish", Version: "B", NumeratorDegree: 6, DenominatorDegree: 5}: &initCacheValue{
			Num:          []float64{0.01853659243861353, 0.5277107512273034, 0.20117380613249639, 0.03832209373051741, 0.011679943979666537, 0.0023613551545517333, 0.00014931209177259579},
			Den:          []float64{-0.10081467482498373, 0.02639142933119019, -0.04020477462038907, 0.0014682829147659123, -0.0003181238003536345},
			GainEstimate: 2.83092668070523},
	}
)
