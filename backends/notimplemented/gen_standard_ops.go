...
func (f Function) Abs(x backends.Op) (backends.Op, error) {
	return nil, f.baseErrFn(backends.OpTypeAbs)
}

// Add returns the element-wise sum of the two values.
// Standard broadcasting rules apply (see documentation).
func (f Function) Add(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
...
func (f Function) Ceil(x backends.Op) (backends.Op, error) {
...
func (f Function) Clamp(min backends.Op, x backends.Op, max backends.Op) (backends.Op, error) {
...
func (f Function) Clz(x backends.Op) (backends.Op, error) {
...
func (f Function) Complex(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
...
func (f Function) Conj(x backends.Op) (backends.Op, error) {
...
func (f Function) ConvGeneral(input backends.Op, kernel backends.Op, axes backends.ConvolveAxesConfig, strides []int, paddings [][2]int, inputDilations []int, kernelDilations []int, channelGroupCount int, batchGroupCount int) (backends.Op, error) {
...
func (f Function) Cos(x backends.Op) (backends.Op, error) {
	return nil, f.baseErrFn(backends.OpTypeCos)
}

// Div returns the element-wise division of the two values.
// Standard broadcasting rules apply (see documentation).
func (f Function) Div(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
...
func (f Function) Dot(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
...
func (f Function) DotGeneral(lhs backends.Op, lhsContractingAxes []int, lhsBatchAxes []int, rhs backends.Op, rhsContractingAxes []int, rhsBatchAxes []int) (backends.Op, error) {
...
func (f Function) DynamicUpdateSlice(operand backends.Op, update backends.Op, startIndices []backends.Op) (backends.Op, error) {
...
func (f Function) Equal(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
...
func (f Function) EqualTotalOrder(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
...
func (f Function) FFT(operand backends.Op, fftType backends.FFTType, fftLength []int) (backends.Op, error) {
	return nil, f.baseErrFn(backends.OpTypeFFT)
}

// Floor returns the Op that represents the output of the corresponding operation.
func (f Function) Floor(x backends.Op) (backends.Op, error) {
...
func (f Function) Gather(operand backends.Op, startIndices backends.Op, indexVectorAxis int, offsetOutputAxes []int, collapsedSliceAxes []int, startIndexMap []int, sliceSizes []int, indicesAreSorted bool) (backends.Op, error) {
...
func (f Function) GreaterOrEqual(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
...
// Standard broadcasting rules apply (see documentation).
// The "TotalOrder" version of the operation enforces `-NaN < -Inf < -Finite < -0 < +0 < +Finite < +Inf < +NaN`.
func (f Function) GreaterOrEqualTotalOrder(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
...
func (f Function) GreaterThan(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
...
// Standard broadcasting rules apply (see documentation).
// The "TotalOrder" version of the operation enforces `-NaN < -Inf < -Finite < -0 < +0 < +Finite < +Inf < +NaN`.
func (f Function) GreaterThanTotalOrder(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
...
func (f Function) Imag(x backends.Op) (backends.Op, error) {
...
func (f Function) IsFinite(x backends.Op) (backends.Op, error) {
...
func (f Function) LessOrEqual(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
...
// Standard broadcasting rules apply (see documentation).
// The "TotalOrder" version of the operation enforces `-NaN < -Inf < -Finite < -0 < +0 < +Finite < +Inf < +NaN`.
func (f Function) LessOrEqualTotalOrder(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
...
func (f Function) LessThan(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
...
// Standard broadcasting rules apply (see documentation).
// The "TotalOrder" version of the operation enforces `-NaN < -Inf < -Finite < -0 < +0 < +Finite < +Inf < +NaN`.
func (f Function) LessThanTotalOrder(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
...
func (f Function) Log(x backends.Op) (backends.Op, error) {
	return nil, f.baseErrFn(backends.OpTypeLog)
}

// Log1p returns the expression log(x+1).
func (f Function) Log1p(x backends.Op) (backends.Op, error) {
	return nil, f.baseErrFn(backends.OpTypeLog1p)
}

// LogicalAnd returns the element-wise logical AND operation.
func (f Function) LogicalAnd(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
...
func (f Function) LogicalNot(x backends.Op) (backends.Op, error) {
	return nil, f.baseErrFn(backends.OpTypeLogicalNot)
}

// LogicalOr returns the element-wise logical OR operation.
func (f Function) LogicalOr(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
	return nil, f.baseErrFn(backends.OpTypeLogicalOr)
}

// LogicalXor returns the element-wise logical XOR operator.
func (f Function) LogicalXor(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
...
func (f Function) NotEqual(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
...
// Standard broadcasting rules apply (see documentation).
// The "TotalOrder" version of the operation enforces `-NaN < -Inf < -Finite < -0 < +0 < +Finite < +Inf < +NaN`.
func (f Function) NotEqualTotalOrder(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
...
func (f Function) Pad(x backends.Op, fillValue backends.Op, axesConfig ...backends.PadAxis) (backends.Op, error) {
	return nil, f.baseErrFn(backends.OpTypePad)
}

// Pow returns the Op that represents the output of the corresponding operation.
func (f Function) Pow(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
...
func (f Function) Real(x backends.Op) (backends.Op, error) {
...
func (f Function) Rem(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
...
func (f Function) ScatterMax(operand backends.Op, scatterIndices backends.Op, updates backends.Op, indexVectorAxis int, updateWindowAxes []int, insertedWindowAxes []int, scatterAxesToOperandAxes []int, indicesAreSorted bool, uniqueIndices bool) (backends.Op, error) {
...
func (f Function) ScatterMin(operand backends.Op, scatterIndices backends.Op, updates backends.Op, indexVectorAxis int, updateWindowAxes []int, insertedWindowAxes []int, scatterAxesToOperandAxes []int, indicesAreSorted bool, uniqueIndices bool) (backends.Op, error) {
	return nil, f.baseErrFn(backends.OpTypeScatterMin)
}

// ScatterSum values from updates pointed by scatterIndices to operand.
func (f Function) ScatterSum(operand backends.Op, scatterIndices backends.Op, updates backends.Op, indexVectorAxis int, updateWindowAxes []int, insertedWindowAxes []int, scatterAxesToOperandAxes []int, indicesAreSorted bool, uniqueIndices bool) (backends.Op, error) {
...
func (f Function) SelectAndScatterMax(operand backends.Op, source backends.Op, windowDimensions []int, windowStrides []int, paddings [][2]int) (backends.Op, error) {
...
// See details in https://openxla.org/xla/operation_semantics#selectandscatter
func (f Function) SelectAndScatterMin(operand backends.Op, source backends.Op, windowDimensions []int, windowStrides []int, paddings [][2]int) (backends.Op, error) {
...
func (f Function) ShiftLeft(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
...
func (f Function) ShiftRightArithmetic(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
...
func (f Function) ShiftRightLogical(lhs backends.Op, rhs backends.Op) (backends.Op, error) {
...
func (f Function) Where(condition backends.Op, onTrue backends.Op, onFalse backends.Op) (backends.Op, error) {
