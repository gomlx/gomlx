...
inputFlat := plan.inputFlat.([]bfloat16.BFloat16) //alt:bf16
kernelFlat := plan.kernelFlat.([]bfloat16.BFloat16) //alt:bf16
outputFlat := plan.outputFlat.([]bfloat16.BFloat16) //alt:bf16
...
var outputValue float32 //alt:bf16
...
outputValue += inputValue.Float32() * kernelValue.Float32() //alt:bf16
...
outputFlat[outputFlatIdx] = bfloat16.FromFloat32(outputValue) //alt:bf16
	}
	return nil
}
