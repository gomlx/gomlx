...
func BaseGEMMSymmetric16Registers_avx2(alpha float32, beta float32, lhsFlat []float32, rhsFlat []float32, batchSize int, lhsCrossSize int, rhsCrossSize int, contractingSize int, outputFlat []float32, bufAllocFn BufAllocFn[float32], bufReleaseFn BufReleaseFn, pool *workerspool.Pool) error {
	numLanes := 8
	params := simd16RegistersParams
	params.RHSL1KernelCols *= numLanes
	lhsBatchStride := lhsCrossSize * contractingSize
...
func BaseGEMMSymmetric16Registers_avx2_Float64(alpha float64, beta float64, lhsFlat []float64, rhsFlat []float64, batchSize int, lhsCrossSize int, rhsCrossSize int, contractingSize int, outputFlat []float64, bufAllocFn BufAllocFn[float64], bufReleaseFn BufReleaseFn, pool *workerspool.Pool) error {
	numLanes := 4
	params := simd16RegistersParams
	params.RHSL1KernelCols *= numLanes
	lhsBatchStride := lhsCrossSize * contractingSize
...
func BaseGEMMSymmetric16RegistersGemmChunk_avx2_Float16(alpha hwy.Float16, beta hwy.Float16, lhs []hwy.Float16, rhs []hwy.Float16, output []hwy.Float16, lhsCrossSize int, rhsCrossSize int, contractingSize int, params *CacheParams, lhsRowStart int, lhsRowEnd int, rhsColStart int, rhsColEnd int, packedLhs []hwy.Float16, packedRhs []hwy.Float16, packedOutput []hwy.Float16) {
...
func BaseGEMMSymmetric16RegistersGemmChunk_avx2_BFloat16(alpha hwy.BFloat16, beta hwy.BFloat16, lhs []hwy.BFloat16, rhs []hwy.BFloat16, output []hwy.BFloat16, lhsCrossSize int, rhsCrossSize int, contractingSize int, params *CacheParams, lhsRowStart int, lhsRowEnd int, rhsColStart int, rhsColEnd int, packedLhs []hwy.BFloat16, packedRhs []hwy.BFloat16, packedOutput []hwy.BFloat16) {
	for rhsPanelColIdx := rhsColStart; rhsPanelColIdx < rhsColEnd; rhsPanelColIdx += params.RHSPanelCrossSize {
		rhsPanelWidth := min(params.RHSPanelCrossSize, rhsColEnd-rhsPanelColIdx)
		for contractingPanelIdx := 0; contractingPanelIdx < contractingSize; contractingPanelIdx += params.PanelContractingSize {
			contractingPanelWidth := min(params.PanelContractingSize, contractingSize-contractingPanelIdx)
...
func BaseGEMMSymmetric16RegistersGemmChunk_avx2_Float64(alpha float64, beta float64, lhs []float64, rhs []float64, output []float64, lhsCrossSize int, rhsCrossSize int, contractingSize int, params *CacheParams, lhsRowStart int, lhsRowEnd int, rhsColStart int, rhsColEnd int, packedLhs []float64, packedRhs []float64, packedOutput []float64) {
	for rhsPanelColIdx := rhsColStart; rhsPanelColIdx < rhsColEnd; rhsPanelColIdx += params.RHSPanelCrossSize {
		rhsPanelWidth := min(params.RHSPanelCrossSize, rhsColEnd-rhsPanelColIdx)
		for contractingPanelIdx := 0; contractingPanelIdx < contractingSize; contractingPanelIdx += params.PanelContractingSize {
			contractingPanelWidth := min(params.PanelContractingSize, contractingSize-contractingPanelIdx)
...
func BaseGEMMSymmetric16RegistersPanel_avx2_Float16(activeContractingLen int, packedLHS []hwy.Float16, packedRHS []hwy.Float16, packedOutput []hwy.Float16, params *CacheParams, lhsActivePanelHeight int, rhsActivePanelWidth int) {
...
func BaseGEMMSymmetric16RegistersPanel_avx2_BFloat16(activeContractingLen int, packedLHS []hwy.BFloat16, packedRHS []hwy.BFloat16, packedOutput []hwy.BFloat16, params *CacheParams, lhsActivePanelHeight int, rhsActivePanelWidth int) {
	_ = packedLHS[activeContractingLen*lhsActivePanelHeight-1].Float32()
	_ = packedRHS[activeContractingLen*rhsActivePanelWidth-1].Float32()
	_ = packedOutput[lhsActivePanelHeight*rhsActivePanelWidth-1].Float32()
	numLanes := 8
...
func BaseGEMMSymmetric16RegistersPanel_avx2(activeContractingLen int, packedLHS []float32, packedRHS []float32, packedOutput []float32, params *CacheParams, lhsActivePanelHeight int, rhsActivePanelWidth int) {
	...
	for lhsRowIdx := 0; lhsRowIdx < lhsActivePanelHeight; lhsRowIdx += params.LHSL1KernelRows {
		...
		for rhsColIdx := 0; rhsColIdx < rhsActivePanelWidth; rhsColIdx += params.RHSL1KernelCols {
			...
			for range activeContractingLen {
				...
				rhsVec1 := archsimd.LoadFloat32x8((*[8]float32)(unsafe.Pointer(&packedRHS[idxRHS+numLanes])))
				idxRHS += 2 * numLanes
				lhsVal0 := packedLHS[idxLHS+0]
				lhsVec0 := archsimd.BroadcastFloat32x8(lhsVal0)
				accum_lhs0_rhs0 = rhsVec0.MulAdd(lhsVec0, accum_lhs0_rhs0)
				accum_lhs0_rhs1 = rhsVec1.MulAdd(lhsVec0, accum_lhs0_rhs1)
				lhsVal1 := packedLHS[idxLHS+1]
				lhsVec1 := archsimd.BroadcastFloat32x8(lhsVal1)
				accum_lhs1_rhs0 = rhsVec0.MulAdd(lhsVec1, accum_lhs1_rhs0)
				accum_lhs1_rhs1 = rhsVec1.MulAdd(lhsVec1, accum_lhs1_rhs1)
				lhsVal2 := packedLHS[idxLHS+2]
				lhsVec2 := archsimd.BroadcastFloat32x8(lhsVal2)
				accum_lhs2_rhs0 = rhsVec0.MulAdd(lhsVec2, accum_lhs2_rhs0)
				accum_lhs2_rhs1 = rhsVec1.MulAdd(lhsVec2, accum_lhs2_rhs1)
				lhsVal3 := packedLHS[idxLHS+3]
				lhsVec3 := archsimd.BroadcastFloat32x8(lhsVal3)
				accum_lhs3_rhs0 = rhsVec0.MulAdd(lhsVec3, accum_lhs3_rhs0)
				accum_lhs3_rhs1 = rhsVec1.MulAdd(lhsVec3, accum_lhs3_rhs1)
				idxLHS += lhsKernelRows
			}
			...
			outputIdx2 := outputIdx0 + 2*params.RHSPanelCrossSize
			outputIdx3 := outputIdx0 + 3*params.RHSPanelCrossSize
			accum_lhs0_rhs0.Store((*[8]float32)(unsafe.Pointer(&packedOutput[outputIdx0])))
			accum_lhs0_rhs1.Store((*[8]float32)(unsafe.Pointer(&packedOutput[outputIdx0+numLanes])))
			accum_lhs1_rhs0.Store((*[8]float32)(unsafe.Pointer(&packedOutput[outputIdx1])))
			accum_lhs1_rhs1.Store((*[8]float32)(unsafe.Pointer(&packedOutput[outputIdx1+numLanes])))
			accum_lhs2_rhs0.Store((*[8]float32)(unsafe.Pointer(&packedOutput[outputIdx2])))
			accum_lhs2_rhs1.Store((*[8]float32)(unsafe.Pointer(&packedOutput[outputIdx2+numLanes])))
			accum_lhs3_rhs0.Store((*[8]float32)(unsafe.Pointer(&packedOutput[outputIdx3])))
			accum_lhs3_rhs1.Store((*[8]float32)(unsafe.Pointer(&packedOutput[outputIdx3+numLanes])))
		}
	}
}

func BaseGEMMSymmetric16RegistersPanel_avx2_Float64(activeContractingLen int, packedLHS []float64, packedRHS []float64, packedOutput []float64, params *CacheParams, lhsActivePanelHeight int, rhsActivePanelWidth int) {
	_ = packedLHS[activeContractingLen*lhsActivePanelHeight-1]
	_ = packedRHS[activeContractingLen*rhsActivePanelWidth-1]
	_ = packedOutput[lhsActivePanelHeight*rhsActivePanelWidth-1]
	numLanes := 4
	for lhsRowIdx := 0; lhsRowIdx < lhsActivePanelHeight; lhsRowIdx += params.LHSL1KernelRows {
		...
		for rhsColIdx := 0; rhsColIdx < rhsActivePanelWidth; rhsColIdx += params.RHSL1KernelCols {
			...
			for range activeContractingLen {
				...
				rhsVec1 := archsimd.LoadFloat64x4((*[4]float64)(unsafe.Pointer(&packedRHS[idxRHS+numLanes])))
				idxRHS += 2 * numLanes
				lhsVal0 := packedLHS[idxLHS+0]
				lhsVec0 := archsimd.BroadcastFloat64x4(lhsVal0)
				accum_lhs0_rhs0 = rhsVec0.MulAdd(lhsVec0, accum_lhs0_rhs0)
				accum_lhs0_rhs1 = rhsVec1.MulAdd(lhsVec0, accum_lhs0_rhs1)
				lhsVal1 := packedLHS[idxLHS+1]
				lhsVec1 := archsimd.BroadcastFloat64x4(lhsVal1)
				accum_lhs1_rhs0 = rhsVec0.MulAdd(lhsVec1, accum_lhs1_rhs0)
				accum_lhs1_rhs1 = rhsVec1.MulAdd(lhsVec1, accum_lhs1_rhs1)
				lhsVal2 := packedLHS[idxLHS+2]
				lhsVec2 := archsimd.BroadcastFloat64x4(lhsVal2)
				accum_lhs2_rhs0 = rhsVec0.MulAdd(lhsVec2, accum_lhs2_rhs0)
				accum_lhs2_rhs1 = rhsVec1.MulAdd(lhsVec2, accum_lhs2_rhs1)
				lhsVal3 := packedLHS[idxLHS+3]
				lhsVec3 := archsimd.BroadcastFloat64x4(lhsVal3)
				accum_lhs3_rhs0 = rhsVec0.MulAdd(lhsVec3, accum_lhs3_rhs0)
				accum_lhs3_rhs1 = rhsVec1.MulAdd(lhsVec3, accum_lhs3_rhs1)
				idxLHS += lhsKernelRows
			}
			...
			outputIdx2 := outputIdx0 + 2*params.RHSPanelCrossSize
			outputIdx3 := outputIdx0 + 3*params.RHSPanelCrossSize
			accum_lhs0_rhs0.Store((*[4]float64)(unsafe.Pointer(&packedOutput[outputIdx0])))
			accum_lhs0_rhs1.Store((*[4]float64)(unsafe.Pointer(&packedOutput[outputIdx0+numLanes])))
			accum_lhs1_rhs0.Store((*[4]float64)(unsafe.Pointer(&packedOutput[outputIdx1])))
			accum_lhs1_rhs1.Store((*[4]float64)(unsafe.Pointer(&packedOutput[outputIdx1+numLanes])))
			accum_lhs2_rhs0.Store((*[4]float64)(unsafe.Pointer(&packedOutput[outputIdx2])))
			accum_lhs2_rhs1.Store((*[4]float64)(unsafe.Pointer(&packedOutput[outputIdx2+numLanes])))
			accum_lhs3_rhs0.Store((*[4]float64)(unsafe.Pointer(&packedOutput[outputIdx3])))
			accum_lhs3_rhs1.Store((*[4]float64)(unsafe.Pointer(&packedOutput[outputIdx3+numLanes])))
		}
	}
}
