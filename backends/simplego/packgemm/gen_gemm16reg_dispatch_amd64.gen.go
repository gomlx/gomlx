...
// GEMMSymmetric16RegistersGemmChunk is the generic API that dispatches to the appropriate SIMD implementation.
...
// GEMMSymmetric16RegistersPanel is the generic API that dispatches to the appropriate SIMD implementation.
