...
// func binaryAddFloat16_neon_asm(a, b, out unsafe.Pointer, n int64)
// Performs out[i] = a[i] + b[i] for n FP16 elements
TEXT ·binaryAddFloat16_neon_asm(SB), NOSPLIT, $0-32
...
// func binaryMulFloat16_neon_asm(a, b, out unsafe.Pointer, n int64)
// Performs out[i] = a[i] * b[i] for n FP16 elements
TEXT ·binaryMulFloat16_neon_asm(SB), NOSPLIT, $0-32
	MOVD a+0(FP), R0
	MOVD b+8(FP), R1
	MOVD out+16(FP), R2
	MOVD n+24(FP), R3
...
// func binarySubFloat16_neon_asm(a, b, out unsafe.Pointer, n int64)
// Performs out[i] = a[i] - b[i] for n FP16 elements
TEXT ·binarySubFloat16_neon_asm(SB), NOSPLIT, $0-32
	MOVD a+0(FP), R0
	MOVD b+8(FP), R1
	MOVD out+16(FP), R2
	MOVD n+24(FP), R3
...
// func binaryDivFloat16_neon_asm(a, b, out unsafe.Pointer, n int64)
// Performs out[i] = a[i] / b[i] for n FP16 elements
TEXT ·binaryDivFloat16_neon_asm(SB), NOSPLIT, $0-32
	MOVD a+0(FP), R0
	MOVD b+8(FP), R1
	MOVD out+16(FP), R2
	MOVD n+24(FP), R3
...
// func binaryAddScalarFloat16_neon_asm(a unsafe.Pointer, scalar uint16, out unsafe.Pointer, n int64)
// Performs out[i] = a[i] + scalar for n FP16 elements
TEXT ·binaryAddScalarFloat16_neon_asm(SB), NOSPLIT, $0-32
	MOVD a+0(FP), R0
...
// func binaryMulScalarFloat16_neon_asm(a unsafe.Pointer, scalar uint16, out unsafe.Pointer, n int64)
// Performs out[i] = a[i] * scalar for n FP16 elements
TEXT ·binaryMulScalarFloat16_neon_asm(SB), NOSPLIT, $0-32
	MOVD a+0(FP), R0
	MOVW scalar+8(FP), R1
	MOVD out+16(FP), R2
	MOVD n+24(FP), R3
